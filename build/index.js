...
var create_relation = function () {
    return __awaiter(this, void 0, void 0, function () {
        var cnt, project, user, company;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, company_1["default"].destroy({
                        where: { name: 'Google' }
                    })];
                case 1:
                    cnt = _a.sent();
                ...
                case 2:
                    cnt = _a.sent();
                    return [4 /*yield*/, project_1["default"].destroy({
                            where: {
                                name: 'big project'
                            }
                        })];
                ...
                case 5:
                    user = _a.sent();
                    return [4 /*yield*/, user.setProject(project)];
                case 6:
                    _a.sent();
                ...
                case 7:
                    company = _a.sent();
                    return [4 /*yield*/, user.setCompany(company)];
                case 8:
                    user = _a.sent();
                    return [2 /*return*/];
            }
